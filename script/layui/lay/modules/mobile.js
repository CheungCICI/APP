...
layui.define(["laytpl", "upload-mobile", "layer-mobile", "zepto"], function (i) {
    var e = "2.0.0",
        ...
        m = function (i, e, t) {
            ...
            return l && (t = e), i = "string" == typeof i ? a(i) : i, /Android|iPhone|SymbianOS|Windows Phone|iPad|iPod/.test(navigator.userAgent) ? void(l ? i.on("touchmove", function () {
                        n = !0
    ...
    var y = function (i) {
            ...
            return i = i || {}, "history" === i.type && (i.item = i.item || "d.sortHistory"), ["{{# var length = 0; layui.each(" + i.item + ", function(i, data){ length++;}}", '<li layim-event="chat" data-tag="{{data.id}}" data-type="' + i.type + '" data-index="' + (i.index ? "{{" + i.index + "}}" : "{{data.type}}{{data.id}}") + '" class="layim-' + ("history" === i.type ? "{{data.type}}" : i.type) + '{{data.id}} {{ data.status === "offline" ? "layim-list-gray" : "" }}"><div><img src="http://o2o.renweinet.com{{data.avatar}}"></div><span>{{ data.username||data.groupname||data.name||"佚名" }}</span><p>{{ data.remark||data.sign||"" }}</p><span class="layim-msg-status">new</span></li>', "{{# }); if(length === 0){ }}", '<li class="layim-null">' + (e[i.type] || "暂无数据") + "</li>", "{{# } }}"].join("")
        },
        p = function (i, e, a) {
            //return ['<div class="layim-panel' + (e ? " layui-m-anim-left" : "") + '">', '<div class="layim-title" style="background-color: {{d.base.chatTitleColor}};">', "<p>", a ? '<i class="layui-icon layim-chat-back" layim-event="back" >&#xe603;</i> {{ d.title || d.base.title }}<span class="layim-chat-status"></span> ' : '<img src="{{ d.base.avatar }}" class="ulogo"><div class="top-nav"><ul class="layui-unselect layui-layim-tab"><li title="消息" layim-event="tab" lay-type="message" class="layim-this"><i class="layui-icon">&#xe611;</i><!--<span>消息</span>--><i class="layim-new" id="LAY_layimNewMsg"></i></li><li title="联系人" layim-event="tab" lay-type="friend"><i class="layui-icon">&#xe612;</i><!--<span>联系人</span>--><i class="layim-new" id="LAY_layimNewList"></i></li><li title="动态" layim-event="tab" lay-type="more"><i class="layui-icon">&#xe600;</i><!--<span>动态</span>--><i class="layim-new" id="LAY_layimNewMore"></i></li></ul></div><span class="layim-chat-status"></span> <i class="layui-icon an-plus" layim-event="popuplist">&#xe654;</i>',"</p>", "</div>", '<div class="layui-unselect layim-content">', i, "</div>", "</div>"].join("")
            return ['<div class="layim-panel' + (e ? " layui-m-anim-left" : "") + '">', '<div class="layim-title" style="background:rgb(253,218,90);z-index:999;line-height: 50px;height: 50px;">', "<p>", a ? '<i class="layui-icon layim-chat-back" layim-event="back" >&#xe603;</i> {{ d.title || d.base.title }}<span class="layim-chat-status"></span> ' : '<img style="display: none" src="{{ d.base.avatar }}" class="ulogo">'+
            '<div class="top-nav"><ul class="layui-unselect layui-layim-tab">' +
            '<li title="消息" layim-event="tab" lay-type="message" class="layim-this">' +
            '<span>消息</span><i class="layim-new" id="LAY_layimNewMsg"></i>' +
            '</li><li title="好友" layim-event="tab" lay-type="friend">' +
            '<span>好友</span><i class="layim-new" id="LAY_layimNewList"></i></li>' +
            '</ul></div>' +
            '<span class="layim-chat-status"></span>' +
            '<i class="layui-icon an-plus" layim-event="popuplist">&#xe654;</i>',"</p>", "</div>", '<div class="layui-unselect layim-content">', i, "</div>", "</div>"].join("")
        },
        f = ['<div class="layui-layim" style="background-color:white !important">', '<div class="layim-tab-content layui-show" style="background-color: white;">' +
        '<div class="chat_chose"><div class="aui-searchbar" id="search" onclick="NewsSearch()"><div class="aui-searchbar-input aui-border-radius" tapmode> ' +
                '<form>' +
                '<input type="search" placeholder="搜索" id="search-input">' +
                '</form></div></div>','<span class="checkpanel"  style="display: none"><button type="button" class="border-1 current" onclick="checkpanel(1,this)">消息</button> <button type="button" class="border-2" onclick="checkpanel(2,this)">群聊</button></span></div>',

            '<ul class="layim-list-friend">', '<ul class="layui-layim-list layui-show layim-list-history">', y({
            type: "history"
        }), "</ul>", "</ul>", "</div>", '<div class="layim-tab-content">',"{{# if(d.base.isNewFriend){ }}", '<ul class="layim-list-topbox"><div class="aui-searchbar" id="search"><div class="aui-searchbar-input aui-border-radius" tapmode onclick="FriendsSearch()"> ' +
                '<form>' +
                '<input type="search" placeholder="搜索" id="search-input">' +
                '</form></div></div><li layim-event="newFriend" class="topbox"><i class="layui-icon an-newfriend">&#xe612;</i>新朋友<i class="layim-new" id="LAY_layimNewFriend"></i></li>',"{{# } if(d.base.isgroup){ }}",'<li layim-event="group" class="topbox"><i class="layui-icon an-qunliao">&#xe613;</i>群聊<i class="layim-new" id="LAY_layimNewGroup"></i></li><li onclick="NearUsers()" class="topbox"><i class="layui-icon an-imkefu">&#xe63a;</i>校友圈<i class="layim-new" id="LAY_layimImKefu"></i></li></ul>',"{{# } }}","</ul><div style='border-bottom: solid 10px whitesmoke;display: block'></div>",'<ul class="layim-list-group used-list" style="background:#fff;">' +
            '<li>' +
            '<h5 style="line-height: 35px;padding-top: 3px;padding-bottom: 3px" layim-event="spread" lay-type="false"><i class="layui-icon" style="padding-top: 3px;padding-bottom: 3px"></i><span>常用群聊</span><em>(<cite class="layim-count">0</cite>)</em></h5>' +
            '<ul class="layui-layim-list"><li class="layim-null">暂无常用群聊</li></ul>' +
            '</li>' +
            '</ul>' , '<ul class="layim-list-friend">', '{{# layui.each(d.friend, function(index, item){ var spread = d.local["spread"+index]; }}', "<li class='data-gid' data-gid='{{ item.id }}'>", '<h5 style="line-height: 35px;padding-top: 3px;padding-bottom: 3px" layim-event="spread" lay-type="{{ spread }}"><i class="layui-icon" style="padding-top: 3px;padding-bottom: 3px">{{# if(spread === "true"){ }}&#xe61a;{{# } else {  }}&#xe602;{{# } }}</i><span>{{ item.groupname||"未命名分组"+index }}</span><em>(<cite class="layim-count"> {{ (item.list||[]).length }}</cite>)</em></h5>', '<ul class="layui-layim-list {{# if(spread === "true"){ }}', " layui-show", '{{# } }}">', y({
            type: "friend",
            item: "item.list",
            index: "index"
        }), "</ul>", "</li>", "{{# }); if(d.friend.length === 0){ }}", '<li><ul class="layui-layim-list layui-show"><li class="layim-null">暂无联系人</li></ul>', "{{# } }}", "</ul>",
             "</div>", '<div class="layim-tab-content">', '<ul class="layim-list-top">', "{{# layui.each(d.base.moreList, function(index, item){ }}", '<li layim-event="moreList" lay-filter="{{ item.alias }}">', '<i class="layui-icon {{item.iconClass||""}}">{{item.iconUnicode||""}}</i>{{item.title}}<i class="layim-new" id="LAY_layimNew{{ item.alias }}"></i>', "</li>", "{{# }); if(!d.base.copyright){ }}","{{# } }}", "</ul>", "</div>", "</div>"].join(""),
        h = ['<div class="layim-chat layim-chat-{{d.data.type}}">', '<div class="layim-chat-main">', "<ul></ul>", "</div>", '<div class="layim-chat-footer">', '<div class="layim-chat-send">' +
        '<input type="text" layim-event="sendtext" style="border: solid 1px lightgrey !important" autocomplete="off"><button class="layim-send layui-disabled"  layim-event="send"> <!--style="margin: 5px 5px 0 0"-->发送</button></div>',
            '<div class="layim-chat-tool" data-json="{{encodeURIComponent(JSON.stringify(d.data))}}">',
            '<span class="layui-icon layim-tool-face chooser_face" title="选择表情" layim-event="face">&#xe60c;</span>',
            "{{# if(d.base && d.base.uploadImage){ }}",
            '<span class="layui-icon layim-tool-image chooser_image" title="上传图片" layim-event="image">&#xe60d;<input type="file" name="file" accept="image/*"></span>',
            "{{# }; }}", "{{# if(d.base && d.base.uploadFile){ }}",
            '<span class="layui-icon layim-tool-image" title="发送文件" style="display:none" layim-event="image" data-type="file">&#xe61d;<input type="file" name="file"></span>',
    ...
    layui.data.date = function (i) {
        ...
        return i = (i || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;").replace(/@(\S+)(\s+?|$)/g, '@<a href="javascript:;">$1</a>$2').replace(/face\[([^\s\[\]]+?)\]/g, function (i) {
            ...
            return '<img class="layui-layim-photos" src="http://o2o.renweinet.com' + i.replace(/(^img\[)|(\]$)/g, "") + '">'
            ...
            return '<div class="layui-unselect layui-layim-audio" layim-event="playAudio" data-src="http://o2o.renweinet.com' + i.replace(/(^audio\[)|(\]$)/g, "") + '"><i class="layui-icon">&#xe652;</i><p>音频消息</p></div>'
        }).replace(/video\[([^\s]+?)\]/g, function (i) {
            return '<div class="layui-unselect layui-layim-video" layim-event="playVideo" data-src="http://o2o.renweinet.com' + i.replace(/(^video\[)|(\]$)/g, "") + '"><i class="layui-icon">&#xe652;</i></div>'
    ...
    var g, b, x = ['<li class="layim-chat-li{{ d.mine ? " layim-chat-mine" : "" }}">', '<div class="layim-chat-user" data-uid="{{ d.id }}" onclick="FriendMore(\'{{ d.id }}\')"><img src="http://o2o.renweinet.com{{ d.avatar }}"><cite>', '{{ d.username||"佚名" }}', "</cite></div>", '<div class="layim-chat-text">{{ layui.data.content(d.content||"&nbsp;") }}</div>', "</li>"].join(""),
        w = {
            message: {},
            chat: []
        },
        C = function (i) {
            ...
            return mine = e.mine || {}, local = layui.data("layim-mobile")[mine.id] || {}, obj = {
                ...
                s.sortHistory = T(s.history, "historyTime"), w = a.extend(w, s), k(t(p(f)).render(s)), layui.each(d.ready, function (i, e) {
                    e && e(s)
                })
        ...
        S = function (i, e) {
            ...
            return n.open({
                ...
                success: function (e) {
                    ...
                    //Ansel新增
                    if(i.isChat==true && i.data.type && i.data.type!='undefined'){
                        var _div=t.find('.layim-title > p'),
                            _html=_div.html();
                        t.find('.layim-title').css('background-color','rgb(253,218,90)');
                        t.find('.layim-title').css('color','rgba(0,0,0,.6)');
                        t.find('.layim-title').css('font-size','17px');
                        if(i.data.type==='group'){
                            _div.html(_html+'<span style="float:right;font-size: 16px;" onclick="GroupMore(\''+i.data.id+'\')">更多</span>');
                        }else if(i.data.type==='friend'){
                            _div.html(_html+'<span onclick="FriendMore(\''+i.data.id+'\')"><i class="layui-icon" style="float:right;font-size: 20px;" >&#xe612;</i> </span>');
                        }
                    }
        ...
        N = function (i, e, t) {
            //Ansel 新增
            if(i.type==='group'){
                layui.each(w.group, function (aa, a) {
                    if (a.id == i.id){
                        i.username=a.groupname;
                        i.name=a.groupname;
                    }
                });
            }
            return i = i || {}, i.id ? (n.close(N.index), N.index = S({
                    ...
                    isChat: !0,
                    success: function (e) {
                        b = a(e), J(), H(), delete w.message[i.type + i.id], _("Msg");
                        var t = A(),
        ...
        j = function (i) {
            ...
            if (g) {
                ...
                var s = l.find(".layim-" + i.type + i.id),
                    ...
                    r = function () {
                        // Ansel 修改数量统计
                        var wdcount=s.find(".layim-msg-status").html()==='new' ? 0 : s.find(".layim-msg-status").html();
                        if(c === 0){
                            wdcount=0;
                        }
                        if(wdcount==null || wdcount=='' || wdcount=='null'){
                            wdcount=0;
                        }
                        s = l.find(".layim-" + i.type + i.id), s.find("p").html(i.content), c > 0 && s.find(".layim-msg-status").html(1+parseInt(wdcount)).addClass(o)
                    };
                if (s.length > 0) r(), l.prepend(s.clone()), s.remove();
                else {
                    a[i.type + i.id] = i;
                    //Ansel 新增
                    if(i.type==='group'){
                    ...
                    l.prepend(d), r(), l.find(".layim-null").remove()
                }
                _("Msg")
            }
        },
        ...
        M = function (i) {
           i = i || {};
            var e = {},
                a = A(),
                n = a.data || {},
                l = n.id == i.id && n.type == i.type;
            if (i.timestamp = i.timestamp || (new Date).getTime(), i.system || F(i), I = JSON.parse(JSON.stringify(i)), w.base.voice && D(), !b && i.content || !l) {
                if (w.message[i.type + i.id]){
                    w.message[i.type + i.id].push(i);
                }else if (w.message[i.type + i.id] = [i], "friend" === i.type) {
                    var s;
                    layui.each(w.friend, function (e, a) {
                        if (layui.each(a.list, function (e, a) {
                                if (a.id == i.id) return a.type = "friend", a.name = a.username, w.chat.push(a), s = !0
                            }), s) return !0
                    }), s || (i.name = i.username, i.temporary = !0, w.chat.push(i))
                }else if ("group" === i.type) {
                    var o;
                    layui.each(w.group, function (e, a) {
                        if (a.id == i.id) return a.type = "group", a.name = a.groupname, w.chat.push(a), o = !0
                    }), o || (i.name = i.groupname, w.chat.push(i))
                } else {
                    i.name = i.name || i.username || i.groupname, w.chat.push(i);
                    "group" === i.type && layui.each(w.group, function (a, t) {
                        if (t.id == i.id) return e.avatar = t.avatar, !0
                    }), !i.system
                }
            }
            ...
            //Ansel 新增
            if("friend" === i.type){
                setread(n.type,i.type,i.id);
            }

            if (j(i), b && l) {
                var c = b.find(".layim-chat"),
                    r = c.find(".layim-chat-main ul");
        ...
        F = function (i) {
            var e = layui.data("layim-mobile")[w.mine.id] || {},
                a = e.chatlog || {};
            a[i.type + i.id] ? (a[i.type + i.id].push(i), a[i.type + i.id].length > r && a[i.type + i.id].shift()) : a[i.type + i.id] = [i], e.chatlog = a, layui.data("layim-mobile", {
                key: w.mine.id,
                value: e
            })
        },
        ...
        $ = function (i) {
            ...
            if (w[i.type])
                if ("friend" === i.type) layui.each(w.friend, function (t, l) {
                    if (i.groupid == l.id) return layui.each(w.friend[t].list, function (a, t) {
                        if (t.id == i.id) return e = !0
                    }), e ? n.msg("好友 [" + (i.username || "") + "] 已经存在列表中", {
                            anim: 6
                        }) : (w.friend[t].list = w.friend[t].list || [], a[w.friend[t].list.length] = i, i.groupIndex = t, w.friend[t].list.push(i), !0)
                });
                else if ("group" === i.type) {
        ...
        B = function () {
            var i = ["[嘻嘻]", "[可爱]", "[调皮]", "[笑脸]", "[忧郁]", "[生气]", "[花痴]", "[恐惧]", "[汗]", "[紧张]", "[哼哼]", "[失落]", "[媚眼]", "[难受]", "[抓狂]", "[瞌睡]", "[吐舌头]", "[晕]", "[大哭]", "[笑哭]", "[尴尬]", "[害羞]", "[开心]", "[愤怒]", "[亲亲]", "[爱你]", "[悠闲]", "[吃惊]", "[口罩]", "[呆]", "[嫌弃]", "[冷汗]", "[鬼怪]", "[恶魔]", "[皇冠]", "[拳头]", "[厉害]", "[向上]", "[加油]", "[耶]", "[挥手]", "[保佑]", "[鼓掌]", "[强壮]", "[吻]", "[老虎]", "[马]", "[小猫]", "[猪头]", "[小狗]", "[狼狗]", "[奶牛]", "[兔子]", "[蛇]", "[母鸡]", "[野猪]", "[老鼠]", "[猴子]", "[章鱼]", "[外星人]", "[大便]", "[天使]", "[花鼠]", "[毛毛虫]", "[小鸡]", "[大象]", "[鸽子]", "[鲸鱼]", "[海豚]", "[企鹅]", "[骆驼]", "[绵羊]", "[树袋熊]", "[热带鱼]", "[青蛙]", "[汽车]", "[帆船]", "[飞机]", "[电车]", "[动车]", "[火箭]", "[网球]", "[棒球]", "[足球]", "[玫瑰]", "[星星]", "[五角星]", "[吉他]", "[篮球]", "[橄榄球]", "[台球]", "[游泳]" ],
                e = {}; 
            return layui.each(i, function (i, a) {
                e[a] = layui.cache.dir + "images/face/" + i + ".png"
            }), e
        }(),
        E = layui.stope,
        P = function (i, e, a) {
        ...
        R = {
            chat: function (i) {
                ...
                if('group' == t){       //修改查找群数据的方式
                    var id = i.attr('class').replace('layim-group', '');
                    for(var lp = 0; lp < w[t].length; lp ++){
                        if(w[t][lp].id == id){
                            s = w[t][lp]; break;
                        }
                    }
                }
                "friend" === t ? s = w[t][n].list[l] : "history" === t && (s = (e.history || {})[n] || {}), s.name = s.name || s.username || s.groupname, "history" !== t && (s.type = t), N(s, !0), a(".layim-" + s.type + s.id).find(".layim-msg-status").removeClass(o)
            }, spread: function (i) {
                ...
                //Ansel 新增
                var _html=g.find('.checkpanel'),
                    _p=g.find('.layim-title .an-plus');
                switch(i.attr('lay-type')){
                    //消息列表
                    case 'message':
                        _html.removeClass('checkpanel_1');
                        g.find('.layim-list-history > li').show();
                        _html.html(CheckPanel.innerHTML);
                        _p.attr('layim-event','popuplist');
                    break;
                    //好友列表
                    case 'friend':
                        _html.addClass('checkpanel_1');
                        _html.html("联系人");
                        _p.attr('layim-event','friendlist');
                    break;
                    //动态
                    case 'more':
                        _html.addClass('checkpanel_1');
                        _html.html("动态");
                        _p.attr('layim-event','morelist');
                        g.find(a).eq(e).html(activityHtml.innerHTML);
                    break;
                };

                i.addClass(c).siblings().removeClass(c), g.find(a).eq(e).addClass(o).siblings(a).removeClass(o);
            }, back: function (i) {
                var e = i.parents(".layui-m-layer").eq(0),
                    a = e.attr("index"),
                    t = ".layim-panel";
                    var div=document.getElementsByClassName('layui-m-layer');
                    if(div.length==2){
                      api.setFrameAttr({
                          name: 'index/im_frm',
                          rect: {
                ...
                }), a(document).off("touchend", R.faceHide).on("touchend", R.faceHide).off("touchmove", R.setmove).on("touchmove", R.setmove), E(e)
            }, faceHide: function () {
                if(move==1){
                    move=0;
                    return;
                ...
                layui.each(d.group, function (i, e) {
                    e && e()
                })
                /*S({
                    title: "群聊",
                ...
                var e = R.playAudio.audio,
                    a = e || document.createElement("audio"),
                    t = function () {
                        a.pause(), i.removeAttr("status"), i.find("i").html("&#xe652;")
                    };
                return a.play ? void(i.attr("status") ? t() : (e || (a.src = i.data("src")), a.play(), i.attr("status", "pause"), R.playAudio.audio = a, i.find("i").html("&#xe651;"), a.onended = function () {
                            t()
                        }, a.onerror = function () {
                            n.msg("播放音频源异常")
                        })) : n.msg("您的浏览器不支持audio")
            ...
            popuplist: function () {
                var data=[{
                    image:'../../static/mobile/images/public/addfriend.png',
                    text:'加好友/群',
                    value:'addfriend'
                },{
                    image:'../../static/mobile/images/public/addgroup.png',
                    text:'创建群',
                    value:'createGroup'
                },{
                    image:'../../static/mobile/images/public/addfriend.png',
                    ...
                    image:'../../static/mobile/images/public/clear.png',
                    text:'清除消息',
                    value:'clear'
                }];
                showPopup('top-right',data);
            },friendlist: function () {
                var data=[{
                    image:'../../static/mobile/images/public/fenzu.png',
                    text:'分组管理',
                    value:'longPress'
                }];
                showPopup('top-right',data);
...
}).addcss("modules/layim/mobile/layim.css?v=2.00", "skinlayim-mobilecss");
