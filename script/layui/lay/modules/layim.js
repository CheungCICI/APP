...
layui.define(["layer", "laytpl", "upload"], function(i) {
    ...
    layui.data.date = function(i) {
        ...
        return i = (i || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;").replace(/@(\S+)(\s+?|$)/g, '@<a href="javascript:;">$1</a>$2').replace(/face\[([^\s\[\]]+?)\]/g, function(i) {
            ...
            return '<img alt="' + a + '" title="' + a + '" src="o2o.renweinet.com' + X[a] + '">'
        }).replace(/img\[([^\s]+?)\]/g, function(i) {
            return '<img class="layui-layim-photos" src="o2o.renweinet.com' + i.replace(/(^img\[)|(\]$)/g, "") + '">'
    ...
    var x, b, w, k, C, S = function(i, a, n) {
        ...
        T = function(i) {
            return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({
                ...
                offset: "rb",
                resize: !1,
                content: '<img src="' + (j.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i || j.base.title || "WEBIM") + "</span>",
        ...
        N = function(i) {
            ...
            w && !i && w.hide(), t.close(N.index), N.index = t.open({
                ...
                resize: !1,
                area: ["182px", "50px"],
                content: '<img id="layui-layim-min" src="o2o.renweinet.com' + a.avatar + '"><span>' + a.name + "</span>",
        ...
        ti = {
                ...
                var a = x.find(".layui-layim-search"),
                    ...
                    n = function(i) {
                        ...
                        if ("" === a) ti.tab(0 | ti.tab.index);
                            ...
                            if (n.length > 0) for (var c = 0; c < n.length; c++) o += '<li layim-event="chat" data-type="' + n[c].type + '" data-index="' + n[c].index + '" data-list="' + n[c].list + '"><img src="o2o.renweinet.com' + n[c].avatar + '"><span>' + (n[c].username || n[c].groupname || "游客") + "</span><p>" + (n[c].remark || n[c].sign || "") + "</p></li>";
                        ...
                        success: function(a) {
                            ...
                            u && s.css({
                                ...
                                layui.each(a.list, function(i, a) {
                                    o += '<li data-uid="' + a.id + '"><a href="javascript:;"><img src="o2o.renweinet.com' + a.avatar + '"><cite>' + a.username + "</cite></a></li>", d[a.id] = a
            ...
            face: function(i, a) {
                var n = "",
                    l = _();
                for (var s in X) n += '<li title="' + s + '"><img src="o2o.renweinet.com' + X[s] + '"></li>';
    ...
    i("layim", new u)
}).addcss("modules/layim/layim.css?v=3.50Pro", "skinlayimcss");
